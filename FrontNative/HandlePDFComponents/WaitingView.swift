...
struct WaitingView: UIViewRepresentable {
    ...
    init(templatePath:String, script:Javascript1, showingView:Binding<String>,fileURL:Binding<URL>) {
    ...
    func makeCoordinator() -> WaitingView.Coordinator {
        Coordinator(parent:self, showingView:$showingView, fileURL:$fileURL)
    }
    ...
    class Coordinator: NSObject, WKNavigationDelegate {
        ...
        init(parent: WaitingView, showingView:Binding<String>,fileURL:Binding<URL>) {
            self.parent = parent
            _showingView = showingView
            _fileURL = fileURL
        }
